...
void pca_set_mode(u8 id,u8 mode){
    ...
    switch(mode){
        ...
        case 5:{//16位捕获模式
            switch(id){
                case 0:pca_ccapmx=ECBM_PCA0_UP_DOWN|0x01;break;
                case 1:pca_ccapmx=ECBM_PCA1_UP_DOWN|0x01;break;
                case 2:pca_ccapmx=ECBM_PCA2_UP_DOWN|0x01;break;
                case 3:pca_ccapmx=ECBM_PCA3_UP_DOWN|0x01;break;
            }
        }break;
        case 6:{//16位软件定时器
